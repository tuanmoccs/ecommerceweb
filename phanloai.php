...
session_start();
 ...
 require('ketnoi/connect.php');
  $idcate = $_GET['id'];
  $sql_str = "select products.id as pid, products.name as pname, images,disscounted_price,price,
  products.category_id as pcateid from products where products.category_id = $idcate ;";
