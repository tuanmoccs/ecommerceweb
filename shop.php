                ...
                <div class="col-lg-9 col-md-7">
                    <div class="product__discount">
                        ...
                        <div class="row">
                            ...
                            <?php
                            require('ketnoi/connect.php');
                            $sql_str = "select * from products LIMIT 6;";
                            $result = mysqli_query($conn,$sql_str);
                            while($row = mysqli_fetch_assoc($result)){ 
                                $arr_img = explode(";",$row['images'])
                            ?>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <!-- <span></span> -->
                                            <h5><a href="chitietsanpham.php?id=<?=$row['id']?>"><?=$row['name']?></a></h5>
                                            <div class="product__item__price"><?=number_format($row['disscounted_price'],0,'','.'). "VND"?> <span><?=number_format($row['price'],0,'','.'). "VND"?></span></div>
                                        </div>
                                    </div>
                                </div>
                                <?php } ?>
